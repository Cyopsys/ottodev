...
const PROVIDER_LIST: ProviderInfo[] = [
  ...
  },
  {
    ...
    staticModels: [
      ...
      { name: 'Qwen/Qwen/QwQ-32B-Preview', label: 'QwQ-32B-Preview (HuggingFace)', provider: 'HuggingFace', maxTokenAllowed: 8000, },
      ...
      { name: 'meta-llama/Llama-3.2-90B-Vision-Instruct', label: 'Llama-3.2-90B-Vision-Instruct (HuggingFace)', provider: 'HuggingFace', maxTokenAllowed: 8000, },
      { name: 'meta-llama/Llama-3.3-70B-Instruct', label: 'Llama-3.3-70B-Instruct (HuggingFace)', provider: 'HuggingFace', maxTokenAllowed: 8000, },
